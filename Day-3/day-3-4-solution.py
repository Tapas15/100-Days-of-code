...
with open('testing_copy.py', 'w') as file:
    ...
    with open('day-3-4-solution.py', 'r') as original:
...
class MyTest(unittest.TestCase):
    ...
    def test_1(self):
        self.run_test(given_answer=['S', 'N', 'Y'],
                      expected_print='Welcome to Python Pizza Deliveries!\nYour final bill is: $16.\n')

    def test_2(self):
        self.run_test(given_answer=['L', 'N', 'N'],
                      expected_print='Welcome to Python Pizza Deliveries!\nYour final bill is: $25.\n')

    def test_3(self):
        self.run_test(given_answer=['M', 'Y', 'N'],
